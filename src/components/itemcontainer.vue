...
<style lang="sass">
	...
	//urls
	$url_0: url(../images/WechatIMG2.png);
	$url_1: url(../images/1-2.png);
	$url_2: url(../images/2-1.png);
	$url_3: url(../images/1-4.png);
	$url_4: url(../images/2-2.png);
	$url_5: url(../images/3-1.png);
